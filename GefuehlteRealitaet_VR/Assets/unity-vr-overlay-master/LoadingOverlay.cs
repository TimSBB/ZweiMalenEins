...
public class LoadingOverlay : MonoBehaviour {
    ...
    void Start(){
        ...
        this.from_color = this.material.GetColor("_UnlitColor");
        this.to_color = this.material.GetColor("_UnlitColor");
        FadeIn();
    }
    ...
    void Update(){
        ...
        this.material.SetColor("_UnlitColor", Color.Lerp(this.from_color, this.to_color, this.fade_timer));
        if(this.material.GetColor("_UnlitColor") == this.to_color){
            this.fading = false;
            this.fade_timer = 0;
        }
    }
    ...
    public void FadeOut(){
        ...
        if(this.to_color != this.material.GetColor("_UnlitColor")){
            this.fading = true;
        }
    }
